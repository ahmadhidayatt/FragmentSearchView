...
public class Toolbar_ActionMode_Callback implements ActionMode.Callback {
    ...
    private WoAdapter recyclerView_adapter;
    private ArrayList<WoHolder> message_models;
    private boolean isListViewFragment;


    public Toolbar_ActionMode_Callback(Context context, WoAdapter recyclerView_adapter, ArrayList<WoHolder> message_models, boolean isListViewFragment) {
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        mode.getMenuInflater().inflate(R.menu.activity_main_menu, menu);//Inflate the menu over action mode
        return true;
    }
...
//                        ((WoList) recyclerFragment).deleteRows();//delete selected rows
////                }
                break;
...
//            if (recyclerFragment != null)
//                ((ConversationList) recyclerFragment).setNullToActionMode();//Set action mode null
////        }
//    }
    }
}
